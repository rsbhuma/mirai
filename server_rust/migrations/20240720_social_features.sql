...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'comment_parent_type') THEN
...
CREATE TABLE IF NOT EXISTS token_stakers (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    token_id UUID NOT NULL REFERENCES tokens(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_feed_items_token_id ON feed_items(token_id);
CREATE INDEX IF NOT EXISTS idx_feed_items_created_at ON feed_items(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_feed_items_is_published ON feed_items(is_published);

CREATE INDEX IF NOT EXISTS idx_discussions_token_id ON discussions(token_id);
...
CREATE INDEX IF NOT EXISTS idx_challenges_token_id ON challenges(token_id);
...
CREATE INDEX IF NOT EXISTS idx_rewards_token_id ON rewards(token_id);
...
CREATE INDEX IF NOT EXISTS idx_token_stakers_user_id ON token_stakers(user_id);
CREATE INDEX IF NOT EXISTS idx_token_stakers_token_id ON token_stakers(token_id);
CREATE INDEX IF NOT EXISTS idx_token_stakers_is_active ON token_stakers(is_active);
...
-- Create triggers
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'trigger_update_feed_item_comments') THEN
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'trigger_update_feed_item_likes') THEN
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'trigger_update_discussion_comments') THEN
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'trigger_update_discussion_likes') THEN
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'trigger_feed_items_updated_at') THEN
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'trigger_discussions_updated_at') THEN
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'trigger_challenges_updated_at') THEN
